PRO p_vrperform_draw3_pan2sub, data, pos=pos, xr=xr, yr=yr, symcolor=symcolor, symsize=symsize

	cut	= WHERE(data.xox.fof3d.stime / data.xxx.fof3d.stime GT yr(1))
	cgOplot, data.xxx.fof3d.ngroup, data.xox.fof3d.stime / data.xxx.fof3d.stime, psym=16, symsize=symsize, color=symcolor(0)
	...
	cut	= WHERE(data.xox.fof6d.stime / data.xxx.fof6d.stime GT yr(1))
	cgOplot, data.xxx.fof6d.ngroup, data.xox.fof6d.stime / data.xxx.fof6d.stime, psym=16, symsize=symsize, color=symcolor(1)
	IF MAX(CUT) GE 0L THEN $
