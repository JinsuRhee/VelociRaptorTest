PRO p_vrperform_draw6, settings, data
	...
	IF settings.P_VRPerform_eps THEN $
		cgPS_open, settings.root_path + 'images/' + settings.P_VRPerform_draw6_iname, /encapsulated
	...
	cgPlot, 0, 0, /nodata, xrange=xr, yrange=yr, position=pos, /xlog, /noerase, $
		ytitle='Rel- SN Vising Times', xstyle=4

	P_VRPerform_draw6_pan1, data, symsize=symsize, symcolor=symcolor, orgcolor=orgcolor, pos=pos, xr=xr
	...
	cgPlot, 0, 0, /nodata, xrange=xr, yrange=yr, position=pos, /xlog, /noerase, $
		xtitle='# of FOF particles', ytitle='Rel- LN Vising Times'

	P_VRPerform_draw6_pan2, data, symsize=symsize, symcolor=symcolor, orgcolor=orgcolor, pos=pos, xr=xr
	...
	;P_VRPerform_draw6_pan1, data, symsize=symsize, symcolor=symcolor, orgcolor=orgcolor
	...
	;P_VRPerform_draw6_pan2, data, symsize=symsize, symcolor=symcolor, orgcolor=orgcolor
