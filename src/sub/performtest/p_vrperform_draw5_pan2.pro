PRO P_VRPerform_draw5_pan2, data, pos=pos, symsize=symsize, xr=xr, yr=yr, lcolor=lcolor, symcolor=symcolor, orgcolor=orgcolor, csize=csize

		a	= LINFIT(ALOG10(data.xxo.fof3d.ngroup), ALOG10(data.xxo.fof3d.stime))
		b	= LINFIT(ALOG10(data.xxo.fof6d.ngroup), ALOG10(data.xxo.fof6d.stime))
	...
	cgOplot, data.xxo.fof3d.ngroup, data.xxo.fof3d.stime, psym=16, color=orgcolor(0), symsize=symsize(1)
	cgOplot, data.xxo.fof6d.ngroup, data.xxo.fof6d.stime, psym=16, color=orgcolor(1), symsize=symsize(1)
