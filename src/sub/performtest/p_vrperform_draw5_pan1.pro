PRO P_VRPerform_draw5_pan1, data, pos=pos, symsize=symsize, xr=xr, yr=yr, lcolor=lcolor, symcolor=symcolor, orgcolor=orgcolor, csize=csize

		a	= LINFIT(ALOG10(data.xxo.fof3d.ngroup), ALOG10(data.xxo.fof3d.time))
		b	= LINFIT(ALOG10(data.xxo.fof6d.ngroup), ALOG10(data.xxo.fof6d.time))
	...
	cgOplot, data.xxo.fof3d.ngroup, data.xxo.fof3d.time, psym=16, color=orgcolor(0), symsize=symsize(1)
	cgOplot, data.xxo.fof6d.ngroup, data.xxo.fof6d.time, psym=16, color=orgcolor(1), symsize=symsize(1)
