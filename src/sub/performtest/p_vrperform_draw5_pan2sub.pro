PRO p_vrperform_draw5_pan2sub, data, pos=pos, xr=xr, yr=yr, symcolor=symcolor, symsize=symsize

		cutval	= 1.2
		ydum	= data.xxo.fof3d.stime / data.xxx.fof3d.stime
	...
	;cgOplot, data.xxx.fof3d.ngroup, data.xxo.fof3d.stime / data.xxx.fof3d.stime, psym=16, symsize=symsize, color=symcolor(0)
	cgOplot, data.xxx.fof6d.ngroup, data.xxo.fof6d.stime / data.xxx.fof6d.stime, psym=16, symsize=symsize, color=symcolor(1)
