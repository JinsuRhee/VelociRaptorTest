Pro rv_save, output, dir_save=dir_save, horg=horg, num_thread=num_thread, $
	n_snap=n_snap, column_list=column_list, flux_list=flux_list
	...
	for i=0L, ngal - 1L do begin
		...
		simple_write_hdf5, output.ABMAG(i,*,*), 'G_Prop/G_ABmag',	fid
		simple_write_hdf5, output.SFR(i,*), 'G_Prop/G_SFR',		fid
