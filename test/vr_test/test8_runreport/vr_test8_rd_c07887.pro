PRO vr_test8_rd_c07887, settings, rp_c07887, skip=skip

IF ~KEYWORD_SET(skip) THEN BEGIN
	path	= '/storage5/FORNAX/VELOCI_RAPTOR/c07887/galaxy/'
	files	= file_search(path + 'snap_*')

	n1 = 0L & n2 = 0L
	;rp_c07887	= fltarr(1,2)
	pp	= [0.0]
	tt	= [0.0]
	...
	SAVE, filename=settings.root_path + 'test/vr_test/test8*/c07887.sav', rp_c07887
ENDIF ELSE BEGIN
	RESTORE, settings.root_path + 'test/vr_test/test8*/c07887.sav'
ENDELSE
