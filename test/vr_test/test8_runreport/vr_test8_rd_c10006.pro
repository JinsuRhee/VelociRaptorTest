PRO vr_test8_rd_c10006, settings, rp_c10006, skip=skip
...
IF ~KEYWORD_SET(skip) THEN BEGIN
	...
	SAVE, filename=settings.root_path + 'test/vr_test/test8*/c10006.sav', rp_c10006
ENDIF ELSE BEGIN
	RESTORE, settings.root_path + 'test/vr_test/test8*/c10006.sav'
ENDELSE
