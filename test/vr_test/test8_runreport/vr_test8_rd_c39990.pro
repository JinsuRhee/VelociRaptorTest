PRO vr_test8_rd_c39990, settings, rp_c39990, skip=skip

IF ~KEYWORD_SET(skip) THEN BEGIN
	;path	= '/storage5/FORNAX/VELOCI_RAPTOR/c10006/galaxy/'
	path	= '/storage5/FORNAX/VELOCI_RAPTOR/YZiCS/c39990/galaxy/'
	...
	SAVE, filename=settings.root_path + 'test/vr_test/test8*/c39990.sav', rp_c39990
ENDIF ELSE BEGIN
	RESTORE, settings.root_path + 'test/vr_test/test8*/c39990.sav'
ENDELSE
