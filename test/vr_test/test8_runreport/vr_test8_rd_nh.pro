PRO vr_test8_rd_nh, settings, rp_NH, skip=skip

IF ~KEYWORD_SET(skip) THEN BEGIN
	path	= '/storage6/jinsu/NH/galaxy/'
	...
	SAVE, filename=settings.root_path + 'test/vr_test/test8*/NH.sav', rp_NH
ENDIF ELSE BEGIN
	RESTORE, settings.root_path + 'test/vr_test/test8*/NH.sav'
ENDELSE
