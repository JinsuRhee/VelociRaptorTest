...
pro rd_gal,gal,nout=nout,dir=dir,idgal=idgal,metal=metal,nchem=nchem,long=long,subdir=dir2
...
endelse
a=FILE_SEARCH(dir + '/gal_stars_'+STRING(idgal,format='(I7.7)'))
IF STRLEN(a) LE 10L THEN dir=dir2
openr,9,dir+'/gal_stars_'+STRING(idgal,format='(I7.7)'),/f77_unformatted
