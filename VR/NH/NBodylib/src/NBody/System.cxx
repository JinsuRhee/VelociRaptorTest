...
namespace NBody
{
    ...
    System::System(long long num, Double_t t, Double_t *p, long long ng, long long ns)
    {
        time = t;
        numparts = num;
        ngas=ng;
    ...
    System::System(long long num, Particle *P, Double_t t, Double_t *p, long long ng, long long ns, GasParticle *gp, StarParticle *sp)
    {
        time = t;
        numparts = num;
        ngas=ng;
    ...
    Double_t System::MaxRadius(bool cmframe) const
    {
        ...
        if (!cmframe) {
            ...
            for (long long i=1;i<numparts;i++)
            {
                temp =S[i].Radius();
                if (temp>r)r=temp;
            }
...
*/
        ...
        if (tolerance > 0.0)
        {
            ...
            while (!done)
            {
                ...
                while (change > tolerance)
                {
                    ...
                    for (long long j = 0; j < numparts; j++)
                    {
    ...
    Double_t System::KineticEnergy(long long i) const
    {
      //System S(*this);
      //S.AdjustForCMVel();
    ...
    Double_t System::KineticEnergy(Coord vel, long long i) const
    {
    ...
    Double_t System::PotentialEnergy(long long i, long long j, Double_t eps) const
    {
        Double_t V=0;
    ...
    Double_t System::PotentialEnergy(long long i, Double_t eps) const
    {
        Double_t V=0;
        Double_t eps2=eps*eps;
        //for (Int_t j=0;j<numparts;j++)
    ...
    Double_t System::PotentialEnergy(Double_t eps, bool sphericalapprox) const
    {
        ...
        else
        {
            ...
            {
                //for (Int_t j=0;j<numparts;j++)
                for (long long j = 0; i < numparts; j++)
                {
    ...
    long long System::FindParticle(const Particle &part) const
    {
      //Int_t i=0;
      long long i;
    ...
    void System::RemoveParticle(Particle part)
    {
      if (numparts >0)
      {
        ...
        long long i=FindParticle(part);
        if (i==-1)
          cerr << "Can't find particle.\n";
        else
        {
            //for (Int_t j=i;j<numparts-1;j++)
            for (long long j=i;j<numparts-1;j++)
            {
    ...
    void System::RemoveParticle(long long i)
    {
    ...
    void System::AddSystem(const System &s, const Double_t* o)
    {
        ...
        for (long long i=numparts;i<(numparts+s.numparts);i++)
        {
    ...
    void System::Write(ofstream &F) const
    {
        ...
        F.write((char *)&numparts, sizeof(long long));
    ...
    void System::Write(FILE *stream) const
    {
        ...
        fwrite(&numparts, sizeof(long long), 1, stream);
    ...
    System& System::operator=(const System &s)
    {
      ...
      for (long long i = 0; i<s.numparts; i++)
    ...
    Particle &System::operator[](long long i)
    {
    ...
    Particle System::operator[](long long i) const
    {
      if (i<numparts) return particle[i];
      else
      {
