...
Int_t *BuildNumInGroupTyped(const long long nbodies, const Int_t numgroups, Int_t *pfof, Particle *P, int type){
    Int_t *numingroup=new Int_t[numgroups+1];
    for (Int_t i=0;i<=numgroups;i++) numingroup[i]=0;
...
Int_t **BuildPGListTyped(const long long nbodies, const Int_t numgroups, Int_t *numingroup, Int_t *pfof, Particle *P, int type){
    Int_t **pglist=new Int_t*[numgroups+1];
    Int_t pid;
    pglist[0]=NULL;
    for (Int_t i=1;i<=numgroups;i++) {
...
Int_t *BuildNoffset(const long long nbodies, Particle *Part, Int_t numgroups,Int_t *numingroup, Int_t *sortval, Int_t ioffset) {
