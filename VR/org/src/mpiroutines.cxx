...
void MPIInitialDomainDecomposition(){
    ...
    if (ThisTask==0) {
        ...
        //}
	//
	//mpi_domain[0].bnd[0][0] = 0;
	//mpi_domain[0].bnd[0][1] = 0.4567966174;
	//mpi_domain[0].bnd[1][0] = 0;
	//mpi_domain[0].bnd[1][1] = 1;
	//mpi_domain[0].bnd[2][0] = 0;
	//mpi_domain[0].bnd[2][1] = 1;

	//mpi_domain[1].bnd[0][0] = 0.4567966174;
	//mpi_domain[1].bnd[0][1] = 1;
	//mpi_domain[1].bnd[1][0] = 0;
	//mpi_domain[1].bnd[1][1] = 0.4583103528;
	//mpi_domain[1].bnd[2][0] = 0;
	//mpi_domain[1].bnd[2][1] = 1;

	//mpi_domain[2].bnd[0][0] = 0.4567966174;
	//mpi_domain[2].bnd[0][1] = 1;
	//mpi_domain[2].bnd[1][0] = 0.4583103528;
	//mpi_domain[2].bnd[1][1] = 1;
	//mpi_domain[2].bnd[2][0] = 0;
	//mpi_domain[2].bnd[2][1] = 0.4574270698;

	//mpi_domain[3].bnd[0][0] = 0.5194645217;
	//mpi_domain[3].bnd[0][1] = 1;
	//mpi_domain[3].bnd[1][0] = 0.4583103528;
	//mpi_domain[3].bnd[1][1] = 1;
	//mpi_domain[3].bnd[2][0] = 0.4574270698;
	//mpi_domain[3].bnd[2][1] = 1;
	//	
	//mpi_domain[4].bnd[0][0] = 0.4567966174;
	//mpi_domain[4].bnd[0][1] = 0.5194645217;
	//mpi_domain[4].bnd[1][0] = 0.5380318172;
	//mpi_domain[4].bnd[1][1] = 1;
	//mpi_domain[4].bnd[2][0] = 0.4574270698;
	//mpi_domain[4].bnd[2][1] = 1;

	//mpi_domain[5].bnd[0][0] = 0.4567966174;
	//mpi_domain[5].bnd[0][1] = 0.5194645217;
	//mpi_domain[5].bnd[1][0] = 0.4583103528;
	//mpi_domain[5].bnd[1][1] = 0.5380318172;
	//mpi_domain[5].bnd[2][0] = 0.5111587008;
	//mpi_domain[5].bnd[2][1] = 1;

	//mpi_domain[6].bnd[0][0] = 0.4567966174;
	//mpi_domain[6].bnd[0][1] = 0.4724672819;
	//mpi_domain[6].bnd[1][0] = 0.4583103528;
	//mpi_domain[6].bnd[1][1] = 0.5380318172;
	//mpi_domain[6].bnd[2][0] = 0.4574270698;
	//mpi_domain[6].bnd[2][1] = 0.5111587008;

	//mpi_domain[7].bnd[0][0] = 0.4567966174;
	//mpi_domain[7].bnd[0][1] = 0.5194645217;
	//mpi_domain[7].bnd[1][0] = 0.4583103528;
	//mpi_domain[7].bnd[1][1] = 0.5380318172;
	//mpi_domain[7].bnd[2][0] = 0.4574270698;
	//mpi_domain[7].bnd[2][1] = 0.5111587008;
...
void MPIDomainDecompositionZOOMIN(int n1, int n2, Double_t x1, Double_t x2){
        if(NProcs > 1)
        {
                //for (int n1 = 0; n1 < NProcs; n1 ++)
                //{
                //      for (int n2 = 0; n2 < 3; n2 ++)
                //      {
                //              mpi_domain[n1].bnd[n2][0] = z_domain[n1][n2][0]
                //              mpi_domain[n1].bnd[n2][1] = z_domain[n1][n2][1]
                //              cout<<n1<<" "<<n2<<" : "<<mpi_domain[n1].bnd[n2][0]<<" "<<mpi_domain[n1].bnd[n2][1]<<endl;
                //      }
                //}
                //cout<<n1<<" | "<<n2<<"   "<<x1<<"   //    "<<x2<<endl;
                mpi_domain[n1].bnd[n2][0] = x1;
                mpi_domain[n1].bnd[n2][1] = x2;
        }
...
void MPIGetExportNum(const long long nbodies, Particle *Part, Double_t rdist){
    long long i, j,nthreads,nexport=0,nimport=0;
...
*/
void MPIGetNNImportNum(const long long nbodies, KDTree *tree, Particle *Part, int iallflag){
    long long i, j,nthreads,nexport=0,ncount;
    Int_t nsend_local[NProcs],noffset[NProcs],nbuffer[NProcs];
...
/*! Mirror to \ref MPIBuildParticleNNExportList, use exported particles, run ball search to find all local particles that need to be
    imported back to exported particle's thread so that a proper NN search can be made.
*/
Int_t MPIBuildParticleNNImportList(Options &opt, const long long nbodies, KDTree *tree, Particle *Part, int iallflag){
    long long i, j,nthreads,nexport=0,ncount;
    Int_t nsend_local[NProcs],noffset[NProcs],nbuffer[NProcs];
    Double_t xsearch[3][2];
    bool *iflagged = new bool[nbodies];
...
{
    long long i,j,nexport=0,nimport=0;
    Int_t nsend_local[NProcs],noffset[NProcs],nbuffer[NProcs];
    Double_t xsearch[3][2];
    Int_t sendTask,recvTask;
    MPI_Status status;
...
{
    long long nthreads,nexport=0,nimport=0;
    Int_t nsend_local[NProcs],noffset[NProcs],nbuffer[NProcs];
    Double_t xsearch[3][2];
    MPI_Status status;
    int indomain;
...
void MPIUpdateExportList(const long long nbodies, Particle *Part, Int_t *&pfof, Int_tree_t *&Len){
    long long i, j,nthreads,nexport;
    Int_t nsend_local[NProcs],noffset[NProcs],nbuffer[NProcs];
    int sendTask,recvTask;
    int maxchunksize=2147483648/NProcs/sizeof(fofdata_in);
    int nsend,nrecv,nsendchunks,nrecvchunks,numsendrecv;
...
Int_t MPIGroupExchange(Options &opt, const long long nbodies, Particle *Part, Int_t *&pfof){
    long long i, j,nthreads,nexport,nimport,nlocal,n;
...
Int_t MPIBaryonCompileGroups(Options &opt, const long long nbodies, Particle *Part, Int_t *&pfof, Int_t minsize, int iorder){
    Int_t i,j,start,ngroups;
    Int_t *numingroup,*groupid,**plist;
    ngroups=0;
...
Int_t MPISearchBaryons(const long long nbaryons, Particle *&Pbaryons, Int_t *&pfofbaryons, Int_t *numingroup, Double_t *localdist, Int_t nsearch, Double_t *param, Double_t *period)
{
    ...
    Coordinate x1;
    Particle p1;
    long long  i, j, k, pindex,nexport=0;
    int tid;
...
Int_t MPIBaryonExchange(Options &opt, const long long nbaryons, Particle *Pbaryons, Int_t *pfofbaryons){
    long long i, j,nthreads,nexport,nimport,nlocal,n;
    Int_t nsend_local[NProcs],noffset_import[NProcs],noffset_export[NProcs],nbuffer[NProcs];
    int sendTask,recvTask;
    int maxchunksize=2147483648/NProcs/sizeof(fofid_in);
...
inline void MPIAdjustGroupIDs(const long long nbodies,Int_t *pfof) {
    Int_t noffset=0;
...
void MPIBuildGridData(const long long ngrid, GridCell *grid, Coordinate *gvel, Matrix *gveldisp){
    long long i, j,nthreads,nexport=0;
    Int_t nsend_local[NProcs],noffset[NProcs],nbuffer[NProcs];
    Int_t sendTask,recvTask;
    MPI_Status status;
