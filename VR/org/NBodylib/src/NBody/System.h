...
*/
  ...
  class System
  {
    ...
    long long numparts, ndark, ngas, nstar;
    //@}
    ...
    System(long long num = 1, Double_t t = 0.0, Double_t *period=NULL, long long ng=0, long long ns=0);
    System(long long num, Particle *p, Double_t t = 0.0, Double_t *period=NULL, long long ng=0, long long ns=0, GasParticle *gp=NULL, StarParticle *sp=NULL);
    ...
    /// \name Get & Set methods
    //@{
    long long GetNumParts() const { return numparts; }
    long long GetNumDark() const { return ndark; }
    long long GetNumGas() const { return ngas; }
    long long GetNumStar() const { return nstar; }
    ...
    Particle &Part(long long i) const { return particle[i]; }
    ...
    //Particle &operator[](long long i);
    //Particle operator[](long long i) const;
