...
void GetGlobalSpatialMorphology(const long long nbodies, Particle *p, Double_t& q, Double_t& s, Double_t Error, Matrix& eigenvec, int imflag, int itype, int iiterate)
{
...
*/
Int_t **SortAccordingtoBindingEnergy(Options &opt, const long long nbodies, Particle *Part, Int_t ngroup, Int_t *&pfof, Int_t *numingroup, PropData *pdata, Int_t ioffset)
{
#ifndef USEMPI
    int ThisTask=0,NProcs=1;
#endif
